      ...
      <div className="mx-auto w-full max-w-[880px] flex-1 px-4 py-10">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-vd-tx2 max-w-[620px] text-[14px] leading-relaxed">
            ...
            released only when a recipient provably satisfies your conditions.
            The enclave signs each decision, so no server — not even ours — can
            release a key off-policy without leaving a forgeable-proof trail.
          </p>
        </div>
          ...
          {isLoading || !info ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-vd-tx3 border-vd-bd border-t pt-3 text-[11.5px] leading-relaxed">
                The <span className="text-vd-tx2">measurement</span> identifies
                the exact enclave build.{" "}
                {info.mode === "coston2"
          ...
          {STEPS.map((s) => {
            ...
            return (
              <div key={s.title} className="surface flex flex-col gap-2.5 p-5">
                ...
                <p className="text-vd-tx3 text-[12px] leading-relaxed">
                  {s.body}
                </p>
              </div>
            );
